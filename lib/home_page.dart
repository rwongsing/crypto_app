...
class _HomePageState extends State<HomePage>implements CryptoListViewContract {
  ...
  ListTile _getListItemUI(Crypto currency) {
    return new ListTile(
      leading: new FadeInImage(placeholder: new NetworkImage("https://image.flaticon.com/icons/png/512/985/985647.png"), image: new NetworkImage("https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@9867bdb19da14e63ffbe63805298fa60bf255cdd/32@2x/color/"+currency.name.toLowerCase() + "@2x.png")),
